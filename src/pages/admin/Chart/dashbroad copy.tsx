...
const Dashboard = () => {
    ...
    return (
        <div>
            ...
            <h2>Thống kê doanh thu <p>Tổng doanh thu: {totalRevenue}</p></h2>
            ...
            <h2>Thống kê số lượng sản phẩm theo size</h2>
                ...
                <div className="row justify-content-center">
                    <div className="col-12">
                        <div className="table-responsive bg-white">
                            <h2 className="mb-5">Thống kê sản phẩm bán chạy</h2>
                            <table className="table mb-0">
                                ...
                                <tbody>
                                    {deliveredOrders.flatMap((order: any, index) => (
                                        <tr >
                                            <th scope="row" style={{ color: '#666666' }}>{order.product[0].product_name}</th>
                                            <td>
                                                <img src={order.product[0].product_images[0]} alt="" style={{ width: 150 }} />
                                            </td>
                                            <td>{order.product[0].sizePrice}</td>
                                            <td>{order.product[0].product_size}</td>
            ...
            <div className="container-xxl">
                <div className="row justify-content-center">
                    <div className="col-12">
                        <div className="table-responsive bg-white">
                            <h2 className="mb-5 fw-bold" >Thống kê sản phẩm mới nhất</h2>
                            <table className="table mb-0">
                                <thead>
                                    <tr>
                                        <th scope="col">Tên sản phẩm</th>
                                ...
                                <tbody>
                                    {products.map((product: any, index) => (
                                        <tr>
                                            ...
                                            <td>
                                                <img src={product.product_images[0]} alt="" style={{ width: 150 }} />
                                            </td>
