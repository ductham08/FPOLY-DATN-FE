        ...
        <>
            ...
            <section className="shop-cart container">
                        ...
                        >
                            ...
                            <Column
                                ...
                                render={
                                    (product_discount) => (
                                        <>
                                            <i style={{ textDecoration: "line-through" }}>{product_discount.product_discount.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</i>
                                            <b style={{ color: "#95532d" }}> {product_discount.sizePrice.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</b>
                                        </>
                                    )}
                            />
                            <Column
                            ...
                            <Column
                                ...
                                render={
                                    (product_discount) => (
                                        <>
                                            <b style={{ color: "#95532d" }}>{(product_discount.sizePrice * product_discount.quantity).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</b>
                                        </>
                                    )}
                            />
                            <Column
                ...
                <div className="total">
                    ...
                    >
                        <h5>Tổng thanh toán ({countProduct} sản phẩm): <b><i style={{ color: "rgb(202, 21, 21)" }}>{totalProduct ? totalProduct.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }) : "0đ"}</i></b></h5>
                        <button
