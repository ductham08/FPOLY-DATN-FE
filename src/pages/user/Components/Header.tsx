        ...
        <>
            ...
            <div className="offcanvas-menu-wrapper">
                ...
                <div className="offcanvas__logo" style={{ width: '98px' }}>
                    <Link to="./index.html">
                        <img src="https://res.cloudinary.com/ductham087/image/upload/v1684771775/MoonShop/heolm38vycienbkrzcxw.png"></img>
                    </Link>
                </div>
                    ...
                    <div className="row">
                        <div className="col-xl-2 col-lg-2">
                            <div className="header__logo" style={{ width: '150px', marginLeft: '140px' }}>
                                <Link to={'/'}><img src="https://res.cloudinary.com/ductham087/image/upload/v1684771775/MoonShop/heolm38vycienbkrzcxw.png"></img></Link>
                            </div>
                        </div>
